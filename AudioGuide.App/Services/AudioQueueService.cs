// File: AudioGuide.App/Services/AudioQueueService.cs
    ...
    public class AudioQueueService : IAudioQueueService
    {
        ...
        private void SaveAudioHistoryToPreferences()
        {
            try
            {
                ...
                var json = System.Text.Json.JsonSerializer.Serialize(_audioPlaybackHistory);
                Preferences.Set(Constants.PreferenceKeyAudioHistory, json);
        ...
        private void LoadAudioHistoryFromPreferences()
        {
            try
            {
                var json = Preferences.Get(Constants.PreferenceKeyAudioHistory, "{}");
                _audioPlaybackHistory = System.Text.Json.JsonSerializer.Deserialize<Dictionary<Guid, DateTime>>(json)
