// File: AudioGuide.App/Services/AppLanguageService.cs
...
namespace AudioGuide.App.Services
{
    ...
    public class AppLanguageService : IAppLanguageService
    {
        ...
        public AppLanguageService()
        {
            ...
            _currentLanguage = Preferences.Get(Constants.PreferenceKeyLanguage, Constants.DefaultLanguage);
        ...
        public void SetLanguage(string languageCode)
        {
            try
            {
                ...
                // Lưu vào Preferences
                Preferences.Set(Constants.PreferenceKeyLanguage, languageCode);
